    ...
    sections: [
      {
        ...
        label: 'Hero',
        fields: [
          { key: 'gallery.hero_title', label: 'Headline', type: 'text', default: 'Moments from Campus' },
          { key: 'gallery.hero_subtitle', label: 'Sub-headline', type: 'textarea', default: 'A visual journey through the life, learning and celebrations at iVintage College.' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        label: 'Hero',
        fields: [
          { key: 'news.hero_title', label: 'Headline', type: 'text', default: 'Stay Updated' },
          { key: 'news.hero_highlight', label: 'Headline highlight', type: 'text', default: 'Latest News' },
          { key: 'news.hero_subtitle', label: 'Sub-headline', type: 'textarea', default: 'Keep up with the latest happenings, events, and announcements at iVintage College.' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        label: 'Hero',
        fields: [
          { key: 'testimonials.hero_title', label: 'Headline', type: 'text', default: 'What Our Community Says' },
          { key: 'testimonials.hero_subtitle', label: 'Sub-headline', type: 'textarea', default: 'Real stories from the students, families and educators who call iVintage home.' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        label: 'Hero',
        fields: [
          { key: 'careers.hero_title', label: 'Headline', type: 'text', default: 'Careers at iVintage' },
          { key: 'careers.hero_subtitle', label: 'Sub-headline', type: 'textarea', default: 'Passionate educators and dedicated staff make iVintage what it is. Explore current openings below.' },
    ...
    sections: [
      {
        ...
        label: 'Hero',
        fields: [
          { key: 'portals.hero_title', label: 'Headline', type: 'text', default: 'Access Your Portal' },
          { key: 'portals.hero_subtitle', label: 'Sub-headline', type: 'textarea', default: 'Choose your portal to access personalised features and stay connected with iVintage College.' },
        ],
      },
    ],
  },
