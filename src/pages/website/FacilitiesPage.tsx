...
const DEFAULT_FACILITIES: Facility[] = [
  { title: 'iVintage College (Day School)', description: 'Purpose-built classrooms on the Akinsanya Estate campus, with small class sizes and dedicated subject teachers.', icon: 'School' },
  { title: 'iVintage Boarding House', description: 'Supervised boarding with structured prep, morning and evening prayers, and full-time house parents.', icon: 'Home' },
  { title: 'iVintage Tahfeedh School', description: 'Dedicated Qur’an memorisation and Arabic programme running alongside the academic curriculum.', icon: 'BookOpen' },
