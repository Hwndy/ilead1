...
export const WhatsAppFloat: React.FC<{ phone?: string; message?: string }> = ({
  ...
  const resolvedPhone = (phone || info.whatsapp_number || '2348134197710').replace(/\D/g, '');
  ...
  return (
    ...
    >
      ...
      <span className="relative flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-transform hover:scale-110 sm:h-14 sm:w-14">
